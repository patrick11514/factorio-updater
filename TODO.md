TODO
- [ ] Add log window, with some basic log levels (info, warn, error)
- [ ] Add login screen with some inputs? And password input should show stars. And the nsave it to config file :) 
